...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didReceiveRemoteNotification notificationInfo: [NSObject : Any]) {
...
//        facade.doTask(UIViewController(), action: DelphosAction.VIEW_BADGE_AWARD)
    ...
    func application(_ application: UIApplication, didReceiveRemoteNotification notificationInfo: [NSObject : AnyObject], handleRemotePush completionHandler: (UIBackgroundFetchResult) -> Void) {
