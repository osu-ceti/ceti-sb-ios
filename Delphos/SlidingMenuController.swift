...
extension UIViewController {
    ...
    func addLeftButtonToRightToggle(buttonImage: UIImage) {
        let leftButton: UIBarButtonItem = UIBarButtonItem(image: buttonImage, style: UIBarButtonItemStyle.Bordered, target: self, action: "toggleRight")
        self.navigationItem.leftBarButtonItem = leftButton;
    }
    
    func addRightButtonToLeftToggle(buttonImage: UIImage) {
        let rightButton: UIBarButtonItem = UIBarButtonItem(image: buttonImage, style: UIBarButtonItemStyle.Bordered, target: self, action: "toggleLeft")
        self.navigationItem.rightBarButtonItem = rightButton;
    }
