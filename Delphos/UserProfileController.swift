...
class UserProfileController:  NavController, UITableViewDataSource, UITableViewDelegate,UICollectionViewDelegateFlowLayout, UICollectionViewDataSource{
    ...
    override func viewDidLoad() {
       ...
       //self.showOverlay(self.view)
        ...
        labelEventFeed.font = UIFont.boldSystemFont(ofSize: 15)
        ...
        bottomLineProfile.frame = CGRect(x: 0, y: btnProfile.frame.size.height, width: btnProfile.frame.size.width, height: 1)
...
//    }
    ...
    @IBAction func btnBadges(_ sender: AnyObject) {
        ...
        bottomLineBadges.frame = CGRect(x: 0, y: btnBadges.frame.size.height, width: btnBadges.frame.size.width, height: 1)
